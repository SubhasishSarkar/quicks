...
const ImwList = () => {
    ...
    useEffect(() => {
        dispatch(setPageAddress({ title: "Inspector List", url: "" }));
    }, []);
    const userType = "INSPECTOR";
    ...
    return (
        <>
            ...
            {userId && <EditUserDataModal lgShow={lgShow} userId={userId} handleClose={handleClose} otherData={otherData} validator={validator} setSearchParams={setSearchParams} />}
        </>
    );
};

export default ImwList;
