...
import CAFNomineeRegistrationForm from "../../../../features/ndfNominee/CAFNomineeRegistrationForm";
import NdfNomineeWorkerTypeSelect from "../../../../features/ndfNominee/NdfNomineeWorkerTypeSelect";

const CAFNomineeRegistration = () => {
    ...
    if (next) {
        ...
        return <CAFNomineeRegistrationForm data={validator.generalize()} />;
    } else return <NdfNomineeWorkerTypeSelect handleContinue={handleContinue} form={form} onChange={onChange} />;
};

export default CAFNomineeRegistration;
