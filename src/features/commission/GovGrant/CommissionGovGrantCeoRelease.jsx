...
const CommissionGovGrantCeoRelease = ({ workerType }) => {
    let total_amount = 0;
    ...
    const { isLoading, error, data, isFetching } = useQuery(["ds-fund-release-list"], () => fetcher(`/ds-fund-release-list?${searchParams}`));
    ...
    const handleCheckSubmit = (e) => {
        ...
        mutate(
            { url: `/ds-fund-release-post`, body: { receipt_id: checkboxSelect, data: data } },
            {
                onSuccess(data) {
                    ...
                    setCheckboxSelect([]);
                    setShowSubmit(false);
                    queryClient.invalidateQueries(["ds-fund-release-list"]);
                },
                onError(error) {
                    setShowSubmit(false);
    ...
    const handleShow = async (e) => {
        ...
        newMutate(
            { url: `/ds-view-release-detail-list/` + release_id },
            {
                onSuccess(data) {
...
export default CommissionGovGrantCeoRelease;
