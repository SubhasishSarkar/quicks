...
const statusTypes = { S: "Pending at Inspector", V: "Pending at ALC", F: "Pending at Board", C: "Pending at CF&CAO", A: "Approved by CF&CAO", M: "Fund Released by Board", 1: "Fund Released" };
const monthFull = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];

const CommissionGovGrantCfcaoForm = ({ workerType }) => {
    let total_amount = 0;
    ...
    const { isLoading, error, data, isFetching } = useQuery(["commission-gov-grant-board", workerType, searchParams], () => fetcher(`/commission-gov-grant-board?${searchParams}`));
        ...
        mutate(
            { url: `/commission-gov-grant-post`, body: { checkboxSelect: checkboxSelect, worker_type: workerTypeShort[workerType] } },
            {
                onSuccess(data) {
                    ...
                    validator.reset();
                    queryClient.invalidateQueries(["commission-gov-grant-board", workerType]);
                },
                onError(error) {
...
export default CommissionGovGrantCfcaoForm;
