...
const CommissionClaimCfcaoForm = ({ workerType }) => {
    let total_amount = 0;
    ...
    const { isLoading, error, data, isFetching } = useQuery(["commission-claim-board", workerType, searchParams], () => fetcher(`/commission-claim-board?${searchParams}`));
    ...
    const handleCheckSubmit = (e) => {
        ...
        mutate(
            { url: `/commission-claim-payment-post`, body: { checkboxSelect: checkboxSelect, worker_type: workerTypeShort[workerType] } },
            {
                onSuccess(data) {
                    setCheckboxSelect([]);
                    ...
                    queryClient.invalidateQueries(["commission-claim-board", workerType]);
                },
                onError(error) {
...
export default CommissionClaimCfcaoForm;
