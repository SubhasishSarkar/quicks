...
const CommissionRegistrationCeoRelease = ({ workerType }) => {
    let total_amount = 0;
    ...
    const { isLoading, error, data } = useQuery(["fund-release-list"], () => fetcher(`/fund-release-list?${searchParams}`));
    ...
    const handleCheckSubmit = (e) => {
        ...
        mutate(
            { url: `/fund-release-post`, body: { receipt_id: checkboxSelect, data: data } },
            {
                onSuccess(data) {
                    ...
                    setCheckboxSelect([]);
                    setShowSubmit(false);
                    queryClient.invalidateQueries(["fund-release-list"]);
                },
                onError(error) {
                    setShowSubmit(false);
    ...
    const handleShow = async (e) => {
        ...
        newMutate(
            { url: `/view-release-detail-list/` + release_id },
            {
                onSuccess(data) {
...
export default CommissionRegistrationCeoRelease;
