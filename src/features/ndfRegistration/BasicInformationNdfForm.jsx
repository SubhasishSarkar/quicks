...
const BasicInformationNdfForm = ({ workerTypeData, nextStep, prevStep }) => {
    ...
    const [form, validator] = useValidate(
        {
            ...
            husband_name: { value: "", validate: "onlyAlphabets" },
            mother_name: { value: "", validate: "onlyAlphabets" },
            ...
            is_ndf: { value: isNDF, validate: "required" },
            ...
            switch (name) {
                ...
                case "dob":
                    setState((state) => {
                        ...
                        if (age < 18 || age > 90) state.dob.error = "Please provide a valid Date of Birth";
                        return { ...state };
                    });
                ...
                case "monthly_family_income":
                    setState((state) => {
                        if (value > 6500 && state.cat_worker_type.value === "ow") {
    ...
    //its specialy for two fields validation when registration_type = OLD
    useEffect(() => {
        validator.setState((state) => {
...
export default BasicInformationNdfForm;
