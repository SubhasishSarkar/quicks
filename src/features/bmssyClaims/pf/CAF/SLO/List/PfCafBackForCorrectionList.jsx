...
const PfCafBackForCorrectionList = () => {
    const cafClaimType = "Back For Correction";
                                    ...
                                    <tr key={index}>
                                        ...
                                        <td style={wrapStyle}>
                                            <button className="btn btn-sm btn-success" style={{ marginRight: "5px" }}>
                                                <Link to={"/claim/pf-caf-details/" + item.enc_caf_claim_id} style={{ textDecoration: "none", color: "#fff" }}>
                                                    View
                                                </Link>
                                            </button>

                                            <button className="btn btn-sm btn-success">
                                                <Link to={"/claim/pf-caf-edit/" + item.enc_caf_claim_id} style={{ textDecoration: "none", color: "#fff" }}>
                                                    Edit
                                                </Link>
                                            </button>
                                        </td>
...
export default PfCafBackForCorrectionList;
