...
const PfClaimEntryByNominee = ({ data }) => {
    const [form, validator] = useValidate(
        {
            ...
            benRlo: { value: data?.benRloCode, validate: "" },
            benWorkerType: { value: data?.workerType, validate: "" },
            benRegNo: { value: data?.registrationNo, validate: "" },
            benApplicationId: { value: data?.applicationId, validate: "" },
...
export default PfClaimEntryByNominee;
