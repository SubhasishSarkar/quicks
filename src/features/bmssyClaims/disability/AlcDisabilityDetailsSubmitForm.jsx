...
export const AlcDisabilityDetailsSubmitForm = ({ id, duplicateBankData, status, SubmitStatus }) => {
    const { data: checkChronological, isLoading: loadingChronological, error } = useQuery(["check-chronological-order", id, status], () => fetcher(`/check-chronological-order?id=${id}&status='${status}'`));
    ...
    const [form, validator] = useValidate({
        ...
        duplicateBankData: { value: duplicateBankData, validate: "" },
    });
