...
const DisabilityClaimEdit = ({ id }) => {
    ...
    const { mutate: updateClaim, isLoading: updateClaimLoading } = useMutation(({ body, method, url }) => updater(url, { method: method || "POST", body: body }));
    ...
    useEffect(() => {
        dispatch(setPageAddress({ title: "Claim List", url: "claim/list", subTitle: "Disability Claim Edit", subUrl: "" }));
    }, []);
            ...
            {data && (
                <div className="card datatable-box  mb-2">
                    <div className="card-header py-2">
                        <h5 className="m-0 font-weight-bold text-white">Please Fill Up Claim Details</h5>
                    </div>
                    <form className="needs-validation" noValidate onSubmit={handleSubmit}>
                        <div className="card-body">
                            ...
                            <div className="card-title mb-4">
                                <h6>
                                    <i className="fa-solid fa-bank"></i> Check Bank Details
                                    <i className="fa-solid fa-circle-check" style={{ color: "#0772f4", fontSize: "12px", marginLeft: "4px" }} title="Bank is verified"></i>
                                </h6>
                            </div>
                            <div className="row mb-4">
                                <div className="col-md-4">
                        ...
                        <div className="card-footer">
                            <div className="d-grid d-md-flex justify-content-md-end">
                                <button className="btn btn-success btn-sm" type="submit" disabled={updateClaimLoading}>
                                    {updateClaimLoading && <span className="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>} Save and Proceed
                                </button>
                            </div>
                        </div>
                    </form>
...
export default DisabilityClaimEdit;
