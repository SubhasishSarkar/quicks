...
function CeoClaimPendingList() {
    ...
    const forwardClaimToCfaco = () => {
        const bodyData = { ids: isCheck, workerType: data?.workerType };
        mutate(
            { url: `/ceo-forwardClaim-to-cfaco`, body: bodyData },
            {
                ...
                <div className="table-responsive">
                    ...
                    <div className="col-md-12 mb-2">
                        <div className="d-grid gap-2 d-md-flex justify-content-md-first">
                            <button className="btn btn-success btn-sm" type="submit" disabled={isCheck.length === 0 || isLoading} onClick={() => forwardClaimToCfaco()}>
                                {isLoading && <span className="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>} Forward To CFACO
                            </button>
                        </div>
                    </div>
                </div>
...
export default CeoClaimPendingList;
