...
const AadharRectificationDifferentPerson = () => {
                                                            ...
                                                            {item.status === "OA" && (
                                                                <>
                                                                    <button type="button" className="btn btn-warning btn-sm">
                                                                        <i className="fa-solid fa-person-walking-arrow-right"></i> Different Person
                                                                    </button>
                                                                    <small className="d-inline-flex px-2 py-1 fw-semibold text-danger bg-danger bg-opacity-10 border border-success border-opacity-10 rounded-2">Aadhaar Needs to be updated.</small>
                                                                </>
                                                            )}
                                                        </div>
                                                    </div>
...
export default AadharRectificationDifferentPerson;
