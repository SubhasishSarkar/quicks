...
const Form1Upload = () => {
    ...
    const DownloadForm1 = async (applicationID) => {
        setLoading(true);
                ...
                <div className="card-body" style={{ position: "relative", overflow: "hidden" }}>
                    <div className="row g-3">
                        <div className="col-md-6" style={{ textAlign: "center", margin: "auto" }}>
                            ...
                            <button type="submit" className="btn btn-success" onClick={() => DownloadForm1(id)} disabled={loading}>
                                Download
                            </button>
                        </div>
                        <div className="col-md-6">
                            <FPUploader
                                ...
                                upload={`/caf-registration?id=${id}&type=documents-details&name=Form-1`}
                            />
                        </div>
                    </div>
                </div>
