...
const BasicInformationForm = ({ workerTypeData, nextStep }) => {
    ...
    const { basicDetails, setBasicDetails } = useContext(RegistrationContext);
    ...
    const [form, validator] = useValidate(
        {
            ...
            registration_no: { value: "", validate: data?.registration_type === "OLD" ? "required" : "" },
            registration_date: { value: "", validate: data?.registration_type === "OLD" ? "required" : "" },
        },
