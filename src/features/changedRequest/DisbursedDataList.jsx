...
const DisbursedDataList = () => {
    const listType = "disbursed";
                                ...
                                {data.data.map((item, index) => {
                                    return (
                                        <tr key={index}>
                                            ...
                                            <td style={wrapStyle}>Disbursed</td>
                                            <td style={wrapStyle}>
                                                <button className="btn btn-sm btn-success">
                                                    {(user.role == "CA" || user.role == "DEO" || ["SLO", "collectingagent", "otherserviceprovider"].includes(user.role)) && (
...
export default DisbursedDataList;
