...
const AddressDetailsForm = ({ nextStep, prevStep, readOnly = false }) => {
    ...
    const [form, validator] = useValidate(
        {
            ...
            same: { value: false, validate: "require" },
            ...
            <form onSubmit={handleSubmit} autoComplete="off">
                <fieldset disabled={readOnly}>
                    <div className="card datatable-box mb-2">
                        <div className="card-body">
                            <div className="card-title">
                                <i className="fa-solid fa-house-flag"></i> Permanent Address
                            </div>
                            <div className="card-body">
                                <div className="row g-3">
                                    <div className="col-md-4">
                                        ...
                                        <StateSelect value="1" disabled className={`form-select`} id="cat_worker_type" name="cat_worker_type" />
                                    </div>
                                    <div className="col-md-4">
                                    ...
                                    <div className="col-md-12">
                                        ...
                                        <textarea
                                            className={`form-control ${form.permanent_address_line.error && "is-invalid"}`}
                    ...
                    <div className="card datatable-box mb-4">
                        <div className="card-body">
                            <div className="card-title">
                                <i className="fa-solid fa-house-fire"></i> Present Address
                            ...
                            <div className="card-body">
                                <div className="row">
                                    ...
                                    <div className="col-md-12">
                                        ...
                                        <textarea
                                            className={`form-control ${form.present_address_line.error && "is-invalid"}`}
