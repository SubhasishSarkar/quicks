...
const DocumentDetails = ({ nextStep, prevStep }) => {
    const { basicDetails, workerType } = useContext(RegistrationContext); //cannot destructuring
    ...
    const DocValidationFunc = () => {
        const stepNext = basicDetails?.registration_type !== "NEW" && (basicDetails?.is_ndf === 0 || basicDetails?.is_ndf === null) ? 6 : 5;
        if (stepNext === 6) {
                ...
                <div className="card-footer" style={{ border: "none", backgroundColor: "transparent" }}>
                    <div className="d-grid d-md-flex justify-content-md-end">
                        <button
                            ...
                            onClick={() => nextStep(["tw", "cw"].includes(workerType) ? 7 : 6)}
                        >
