...
const NomineeDetailsForm = ({ nextStep, prevStep }) => {
    ...
    const { isFetching, data, error } = useQuery(["caf-registration-preview", "nominee-details", application_id], () => fetcher(`/caf-registration-preview?id=${application_id}&step_name=nominee-details`), {
        ...disableQuery,
