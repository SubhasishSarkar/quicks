...
const NdfNomineeWorkerTypeSelect = ({ onChange, form, handleContinue }) => {
    const navigate = useNavigate();
    return (
        <form className="needs-validation" noValidate onSubmit={handleContinue}>
            <div className="card datatable-box shadow mb-4">
                <div className="card-body">
                <h5 className="m-0 font-weight-bold ">NDF Nominee Registration</h5>
                    <p className="mb-0">
                    ...
                    <div className="d-flex gap-3">
                        <button className="btn btn-primary btn-sm mt-4 btn-danger" type="button" onClick={() => navigate("/caf")}>
                            Cancel
                        </button>
                        <button className="btn btn-primary btn-sm mt-4 btn-success" type="submit">
                            Submit
                        </button>
                    </div>
                </div>
...
export default NdfNomineeWorkerTypeSelect;
