...
const FinalNomineeReview = ({ nextStep, prevStep, isActive }) => {
    ...
    const { data, refetch,error,isFetching } = useQuery(["caf-registration-preview", "final-submit", application_id], () => fetcher(`/caf-registration-preview?id=${application_id}&step_name=final-submit`), {
