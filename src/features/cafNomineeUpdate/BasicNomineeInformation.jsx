...
const BasicNomineeInformation = ({ workerTypeData, nextStep, prevStep }) => {
    ...
    const beneficiary_type = searchParams.get("beneficiary_type") || 0;
    ...
    const [form, validator] = useValidate(
        {
            registration_type: { value: data?.registration_type === "" ? "NEW" : data?.registration_type === "NEW" ? "NEW" : data?.registration_type === "OLD" ? "OLD" : "OLD", validate: "" },
            is_ndf: { value: data?.ssin_no === "" ? 1 : data?.ssin_no === "0" ? 1 : data?.ssin_no > 0 ? 0 : 1, validate: "" },
            ...
            new_caf: { value: "", validate: "required" },
            nominee_name: { value: "", validate: "onlyAlphabets|required" },
            ...
            switch (name) {
                case "cat_worker_type":
                    setState((state) => {
                        ...
                        if (data?.cat_worker_type === "tw" || data?.cat_worker_type === "cw") {
                ...
                case "monthly_family_income":
                    setState((state) => {
                        if (value > 6500) {
                            ...
                            state.monthly_family_income.error = "Please provide a valid Monthly Family Income ";
                        }
                        return { ...state };
                    });
                    break;
                    ...
                    setState((state) => {
                        if (value) {
                            ...
                            if (validateDate >= minDate && validateDate <= maxDate) {
                                ...
                                state.registration_date.error = "Death Beneficiary Registration Date must be between 01-01-2001 to 31-03-2017";
                            }
                        }
                        return { ...state };
                    });
    ...
    useEffect(() => {
        if (form.new_caf.value === 0 && ["0", "1", "2"].includes(beneficiary_type)) {
            validator.setState((state) => {
                state.new_caf.value = beneficiary_type;
                state.new_caf.error = null;
                return { ...state };
            });
        }
    ...
    useEffect(() => {
        validator.setState((state) => {
            ...
            if (data?.registration_type === "OLD" && data?.new_caf === 1 && data?.is_ndf === 0) {
            ...
            if (data?.new_caf === 0) {
                state.new_caf.error = "Please Select Beneficiary Type";
            } else {
                state.new_caf.error = "";
                state.new_caf.required = "";
                state.new_caf.validate = "";
            }
        ...
        <>
            ...
            <div className="card" style={{ border: "none" }}>
                <form onSubmit={handleSubmit} noValidate autoComplete="off">
                    <div className="card-body">
                        <div className="row g-3">
                            ...
                            <div className="col-md-3">
                                ...
                                <input placeholder="SSIN" className={`form-control ${form.ssin.error && "is-invalid"}`} type="text" value={form.ssin.value} name="ssin" id="ssin" onChange={(e) => handleChange(e.currentTarget)} />
                            ...
                            <div className="col-md-3">
                                ...
                                <div className="invalid-feedback">Please provide a middle name.</div>
                            </div>
                            <div className="col-md-3">
                                ...
                                <input
                                    ...
                                    onBlur={async (e) => {
                                        try {
                                            ...
                                            setCollectedByName({ name: null, error: `${error.message}` });
                    ...
                    <div className="card-footer d-flex justify-content-md-end" style={{ border: "none", backgroundColor: "transparent" }}>
