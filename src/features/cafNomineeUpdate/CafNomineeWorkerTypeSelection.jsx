...
const CafNomineeWorkerTypeSelection = ({ onChange, form, handleContinue }) => {
    const dispatch = useDispatch();
    useEffect(() => {
        dispatch(setPageAddress({ title: "CAF Nominee Updation", url: "" }));
    }, []);
...
export default CafNomineeWorkerTypeSelection;
